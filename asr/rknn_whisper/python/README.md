...
# such as: 
python convert.py ../model/whisper_encoder_base_6s.onnx rk3576
# output model will be saved as ../model/whisper_encoder_base_20s.rknn

python convert.py ../model/whisper_decoder_base_6s.onnx rk3576
...
# such as:
python whisper_demo.py --encoder_model_path ../model/whisper_encoder_base_20s.onnx --decoder_model_path ../model/whisper_decoder_base_20s.onnx --task en --audio_path ../model/test_en.wav
...
# such as 
./build-android.sh -t rk3576 -a arm64-v8a -d whisper
```
